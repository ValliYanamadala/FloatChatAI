...
function Analytics() {
  ...
  const [floatA, setFloatA] = useState(selectedFloats[0] || "2901234");
  const [floatB, setFloatB] = useState(selectedFloats[1] || "2901240");
  ...
  const [hasComparison, setHasComparison] = useState(
    Boolean(selectedFloats[0] && selectedFloats[1]) || true
  );
  ...
  const handleCompare = () => {
    setHasComparison(Boolean(floatA && floatB));
  };
